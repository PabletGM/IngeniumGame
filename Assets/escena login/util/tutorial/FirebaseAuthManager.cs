...
public class FirebaseAuthManager : MonoBehaviour
{
   ...
   void AuthStateChanged(object sender, System.EventArgs eventArgs)
   {
    ...
    //comienza corrutina de login pasando texto de email y contraseña
   public void Login()
   {
   ...
   private IEnumerator LoginAsync(string email, string password)
   {
       ...
       yield return new WaitUntil(() => loginTask.IsCompleted);
        ...
        //si la excepcion no es null signiifica que hay excepcion y por lo tanto no ha iniciado sesion
    ...
    //comienza corrutina de register pasando texto de email y contraseña
       ...
       else
       {
           ...
           else
           {
               ...
               else
               {
                   ...
                   UIManagerLogin.GetInstanceUI().OpenLoginPanel();
               }
           }
       }
   }
